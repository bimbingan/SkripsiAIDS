<?php /* Smarty version Smarty-3.0.7, created on 2015-08-17 13:57:40
         compiled from "application/views\settings/menu/edit.html" */ ?>
<?php /*%%SmartyHeaderCode:2282355d1cc34823469-56234879%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '2282355d1cc34823469-56234879',
  'function' => 
  array (
  ),
...
<?php $_tmp4=ob_get_clean();?><?php if ($_tmp4=="0"){?>selected="selected"<?php }?>>Tidak</option>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="nav_icon" class="icp-auto" value="<?php echo $_smarty_tpl->getVariable('result')->value['nav_icon'];?>
" /> &nbsp; <i class="fa fa-2x <?php echo $_smarty_tpl->getVariable('result')->value['nav_icon'];?>
"></i>
            </td>
        </tr>
        <tr>
